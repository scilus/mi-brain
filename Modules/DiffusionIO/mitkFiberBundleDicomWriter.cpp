...
void mitk::FiberBundleDicomWriter::Write()
{
  try
  {
    ...
    algorithmId.getAlgorithmNameCode().set(algo_code_value.c_str(), "DCM", algo_code_meaning.c_str());
    algorithmId.setAlgorithmName("MITK Diffusion");
    algorithmId.setAlgorithmVersion("1.0");
