...
*/
void mitk::MitkFiberMapper3D::InternalGenerateData(mitk::BaseRenderer *renderer)
{
...
void mitk::MitkFiberMapper3D::UpdateShaderParameter(mitk::BaseRenderer *)
{
  // see new vtkShaderCallback3D
}

void mitk::MitkFiberMapper3D::SetDefaultProperties(mitk::DataNode* node, mitk::BaseRenderer* renderer, bool overwrite)
{
...
mitk::MitkFiberMapper3D::LocalStorage3D::LocalStorage3D()
{
  ...
  m_FiberMapper = vtkSmartPointer<vtkFiberMapper>::New();
